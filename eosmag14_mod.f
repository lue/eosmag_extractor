...
*      read*,B12,T6,RHO
    ...
    1 continue
      ...
      GAMAG=B12*UN_B12
    2 continue
      call EOSMAG(Zion,CMI,RHO,TEMP,GAMAG,
     *  DENS,GAMI,CHI,TPT,LIQSOL,PnkT,UNkT,SNk,CV,CHIR,CHIT)
      Tnk=8.31447d13/CMI*RHO*T6 ! n_i kT [erg/cc]
...
* LIQSOL = 0 in the liquid state, = 1 in the solid state
      write(*,111) RHO,P,PnkT,CV,CHIT,CHIR,UNkT,SNk,GAMI,TPT,CHI,
     *  LIQSOL
*      write(*,'('' Next RHO ( < 0 to new B and T): ''$)')
*      read*,RHO
*      if (RHO.gt.0.) goto 2
*      write(*,'('' Next B12,T6 ( < 0 to stop): ''$)')
*      read*,B12,T6
*      if (T6.le.0..or.B12.lt.0.) stop
*      write(*,'('' RHO: ''$)')
*      read*,RHO
*      goto 1
  110 format(' Output of eosmag v.27.05.12'/
     *  '   Zion      CMI'/1P,2E11.4/
     *  ' rho [g/cc]  P [Mbar]  P/(n_i kT)  Cv/N_i',
     *  '     chi_T      chi_r    U/(N_i kT)    S/N_i     Gamma_i',
     *  '   T_p/T   chi_e   liq/sol'/'   B12      T6')
  111 format(1P,11E11.3,I2)
      end
